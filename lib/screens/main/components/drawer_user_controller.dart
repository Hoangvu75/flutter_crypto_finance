...
class _DrawerUserControllerState extends State<DrawerUserController> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      ...
      } else if (scrollController.offset > 0 && scrollController.offset < scrollController.position.maxScrollExtent.floor()) {
        iconAnimationController.animateTo((scrollController.offset * 100 / (scrollController.position.maxScrollExtent)) / 100,
            duration: const Duration(milliseconds: 0), curve: Curves.fastOutSlowIn);
      } else {
        if (scrollOffset != 0.0) {
          setState(() {
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? child) {
                      return Transform(
                        ...
                        child: HomeDrawer(
                          screenIndex: widget.screenIndex ?? DrawerIndex.currency,
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: ScaleTap(
                            ...
                            child: Container(
                              width: sizeWidth(context) * 0.125,
                              height: sizeWidth(context) * 0.125,
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(sizeWidth(context) * 0.125),
